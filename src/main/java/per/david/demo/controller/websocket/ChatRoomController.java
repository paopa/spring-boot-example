...
import per.david.demo.worker.websocket.old.WebSocketWorker;
...
//        WebSocketSession webSocketSession = WebSocketWorker.get(token);
...
//        log.info("map = {}", map);
//        WebSocketSession webSocketSession = WebSocketWorker.get(map.get("name"));
//        if (webSocketSession != null) {
